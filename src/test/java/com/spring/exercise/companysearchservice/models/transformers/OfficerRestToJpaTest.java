...
class OfficerRestToJpaTest {
    private final List<com.spring.exercise.companysearchservice.models.rest.Officer> inputOfficers = new ArrayList<>();

    @BeforeEach
    void setup() {
        inputOfficers.add(com.spring.exercise.companysearchservice.models.rest.Officer.builder()
                .officerRole("Director")
                .name("first name")
                .appointedOn(Date.valueOf("2001-11-12"))
                .resignedOn(Date.valueOf("2021-12-11"))
                .address(com.spring.exercise.companysearchservice.models.rest.Address.builder()
                        .postalCode("SW23AD")
                        .premises("first")
    ...
    @Test
    @DisplayName("Test Officer transformer from rest to jpa model")
    void testConversion() {
        List<Officer> officerList = OfficerRestToJpa.convert("1234567",inputOfficers);
    ...
    @Test
    @DisplayName("Test Officer transformer from rest to jpa model, when officer.address is null")
